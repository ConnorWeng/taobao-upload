...
class IndexAction extends CommonAction {
    ...
    public function offerNew() {
        ...
        if ($result->result->success) {
            ...
            Log::write('[ alibaba_error] accessToken:'.session('access_token').' taobaoItemId:'.$taobaoItemId.' errorMessage:'.json_encode($result).' offer params:'.$offer);
            $this->assign(array(
                'result' => '发布失败！'.json_encode($result),
