...
class IndexAction extends Action {
    ...
    public function addItem() {
        ...
        if ($response->errorCode == 0) {
            ...
            Log::write('[ paipai_error ] accessToken:'.session('paipai_access_token').' errorCode:'.$response->errorCode.' errorMessage:'.$response->errorMessage.' itemAttrs:'.htmlspecialchars_decode(dump($itemAttrs, false)), Log::ERR);
            $this->assign(array(
